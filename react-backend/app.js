...
const fetchVisitsSortedBy = require('./routes/fetchVisitsSortedBy');
const fetchVisitsFilteredBy = require('./routes/fetchVisitsFilteredBy');
...
app.use('/fetchVisitsSortedBy', isAuthenticated, fetchVisitsSortedBy);
app.use('/fetchVisitsFilteredBy', isAuthenticated, fetchVisitsFilteredBy);
