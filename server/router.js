...
const exportVisits = require('./routes/export_visits');
...
// Not open but potentially following api plan
router.use('/cb/feedback', cbFeedback);
...
router.use('/cb/export', mwAdminIsAuthenticated, exportVisits);
